...
def generate_obj_renders(
    num_views: int = 40, data_dir: str = DATA_DIR,objName:str="cow", azimuth_range: float = 180
):
    """
    ...
    cow_mesh_files = [
        os.path.join(data_dir, fl) for fl in (objName+".obj", objName+".mtl", objName+".png")
    ]
    ...
    # Load obj file
    obj_filename = os.path.join(data_dir, objName+".obj")
